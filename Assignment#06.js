//Task : 06 [Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and 
...
var naame = "\t \n  Noor Ul Ain  \n \t";
console.log("Name: ", naame);
console.log("Stripped: ", naame.trim());
