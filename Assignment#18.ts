...
let fav_places: string[] = ['Paris', 'Europe', 'Istanbul'];
...
let arrange_placelist: string[] = fav_places.slice().sort();
...
let revplacelist: string[] = arrange_placelist.slice().reverse();
...
let revoriginallist: string[] = fav_places.slice().reverse();
console.log("Reverse Original Order: ",revoriginallist);

// Part : 8
// Reverse the order of your list again. Print the list to show it’s back to its original order.

let backtoorigin: string[] = revoriginallist.reverse();
console.log("Back to original: ",backtoorigin);

// Part : 9
// Sort your array so it’s stored in alphabetical order. Print the array to show that its order has been changed.

let alphabetical_placelist: string[] = fav_places.sort();
...
let rev_alpha_list: string[] = alphabetical_placelist.reverse();
